...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-[100] bg-black/50 backdrop-blur-sm">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-95 z-[200] backdrop-blur-md">
